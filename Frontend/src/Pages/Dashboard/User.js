...
export const User = () => {
  ...
  const fetchAdmins = async () => {
    try {
      ...
      Swal.fire({
        title: "Error",
        text: "An error occurred while fetching admins.",
        icon: "error",
        confirmButtonText: "OK",
      });
    }
  ...
  useEffect(() => {
    ...
    socket.on("adminAdded", (data) => {
      ...
      Swal.fire({
        title: "Admin Added",
        text: "An admin was added by another user.",
        icon: "info",
        confirmButtonText: "OK",
      });
    });
    ...
    socket.on("adminUpdated", (data) => {
      ...
      Swal.fire({
        title: "Admin Updated",
        text: "An admin was updated by another user.",
        icon: "info",
        confirmButtonText: "OK",
      });
    });
    ...
    socket.on("adminDeleted", (data) => {
      ...
      Swal.fire({
        title: "Admin Deleted",
        text: "An admin was deleted by another user.",
        icon: "info",
        confirmButtonText: "OK",
      });
    });
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (response.ok) {
        Swal.fire({
          title: "Success",
          text: editingUserId ? "Admin updated successfully!" : "Admin created successfully!",
          icon: "success",
          confirmButtonText: "OK",
        });
        setShowModal(false);
